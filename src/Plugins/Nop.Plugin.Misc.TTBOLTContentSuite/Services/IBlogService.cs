...
/// </summary>
public partial interface ITTBlogService
{
    #region Blog posts
    ...
    Task DeleteBlogPostAsync(TTBlogPost blogPost);
    ...
    /// </returns>
    Task<TTBlogPost> GetBlogPostByIdAsync(int blogPostId);
    ...
    /// </returns>
    Task<IPagedList<TTBlogPost>> GetAllBlogPostsAsync(int storeId = 0, int languageId = 0,
    ...
    /// The task result contains the blog posts
    /// </returns>
    Task<IPagedList<TTBlogPost>> GetAllBlogPostsByTagAsync(int storeId = 0,
    ...
    /// <param name="blogPost">Blog post</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task InsertBlogPostAsync(TTBlogPost blogPost);
    ...
    /// <param name="blogPost">Blog post</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task UpdateBlogPostAsync(TTBlogPost blogPost);
    ...
    /// </returns>
    Task<IList<TTBlogPost>> GetPostsByDateAsync(IList<TTBlogPost> blogPosts, DateTime dateFrom, DateTime dateTo);
    ...
    /// </returns>
    Task<IList<string>> ParseTagsAsync(TTBlogPost blogPost);
    ...
    bool BlogPostIsAvailable(TTBlogPost blogPost, DateTime? dateTime = null);
    ...
    /// </returns>
    Task<int> GetBlogCommentsCountAsync(TTBlogPost blogPost, int storeId = 0, bool? isApproved = null);
