...
public partial class BlogModelFactory : IBlogModelFactory
{
    ...
    protected readonly ITTBlogService _blogService;
    ...
    public virtual async Task PrepareBlogPostModelAsync(TTBlogPostModel model,TTBlogPost blogPost, bool prepareComments)
    {
    ...
    /// </returns>
    public virtual async Task<TTBlogPostListModel> PrepareBlogPostListModelAsync(BlogPagingFilteringModel command)
    {
        ...
        var model = new TTBlogPostListModel
        {
            ...
            {
                var blogPostModel = new TTBlogPostModel();
