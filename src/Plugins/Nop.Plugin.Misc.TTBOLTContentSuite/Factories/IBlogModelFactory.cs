...
public partial interface IBlogModelFactory
{
    ...
    Task PrepareBlogPostModelAsync(TTBlogPostModel model, TTBlogPost blogPost, bool prepareComments);
    ...
    /// </returns>
    Task<TTBlogPostListModel> PrepareBlogPostListModelAsync(BlogPagingFilteringModel command);
