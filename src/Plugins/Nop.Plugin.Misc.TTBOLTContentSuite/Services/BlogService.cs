...
/// Blog service
/// </summary>
public partial class TTBlogService : ITTBlogService
{
    #region Fields

    protected readonly IRepository<BlogComment> _blogCommentRepository;
    protected readonly IRepository<TTBlogPost> _blogPostRepository;
    ...
    public virtual async Task DeleteBlogPostAsync(TTBlogPost blogPost)
    {
    ...
    /// </returns>
    public virtual async Task<TTBlogPost> GetBlogPostByIdAsync(int blogPostId)
    {
    ...
    /// </returns>
    public virtual async Task<IPagedList<TTBlogPost>> GetAllBlogPostsAsync(int storeId = 0, int languageId = 0,
    ...
    /// The task result contains the blog posts
    /// </returns>
    public virtual async Task<IPagedList<TTBlogPost>> GetAllBlogPostsByTagAsync(int storeId = 0,
        ...
        int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
    {
        ...
        var taggedBlogPosts = new List<TTBlogPost>();
        ...
        //server-side paging
        var result = new PagedList<TTBlogPost>(taggedBlogPosts, pageIndex, pageSize);
        return result;
    }
    ...
    /// <param name="blogPost">Blog post</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task InsertBlogPostAsync(TTBlogPost blogPost)
    {
    ...
    /// <param name="blogPost">Blog post</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task UpdateBlogPostAsync(TTBlogPost blogPost)
    {
    ...
    /// </returns>
    public virtual async Task<IList<TTBlogPost>> GetPostsByDateAsync(IList<TTBlogPost> blogPosts, DateTime dateFrom, DateTime dateTo)
    {
    ...
    /// </returns>
    public virtual async Task<IList<string>> ParseTagsAsync(TTBlogPost blogPost)
    {
    ...
    public virtual bool BlogPostIsAvailable(TTBlogPost blogPost, DateTime? dateTime = null)
    {
        ArgumentNullException.ThrowIfNull(blogPost);
    ...
    /// </returns>
    public virtual async Task<int> GetBlogCommentsCountAsync(TTBlogPost blogPost, int storeId = 0, bool? isApproved = null)
    {
